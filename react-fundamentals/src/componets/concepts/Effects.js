        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>
                        Effects are used to trigger certain actions based =upon changes to a component
                    </li>
                    <li>Effects can return cleanup functions, which can clean up timers using memory, listeners to outside API's, and other funcitons which may use system resources</li>
                </ul>
                <SampleEffect />
                <br />
            <SampleEffect />
...
const SampleEffect = () => {
    ...
    useEffect(() => {
        console.log('This is for the challenge');
    }, []);
    let buttonHandler = () => {
        if (!timerRunning){
